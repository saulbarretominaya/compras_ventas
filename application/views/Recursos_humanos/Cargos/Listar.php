    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cargos
                        <a href="<?php echo base_url(); ?>Recursos_humanos/Controller_cargos/enlace_insertar" class="btn btn-primary btn-sm">REGISTRAR</a>
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <table id="listar" class="table table-bordered table-sm table-hover" style="width: 100%;">
                            ...
                            <tbody>
                                <?php foreach ($listar_cargos as $grilla_cargos) : ?>
                                    <tr>
                                        <td><?php echo $grilla_cargos->id_cargo; ?></td>
                                        <td><?php echo $grilla_cargos->ds_cargo; ?></td>
                                        <?php $datamodal_cargos = $grilla_cargos->id_cargo . "*" . $grilla_cargos->ds_cargo; ?>
                                        <td><button type="button" class="btn btn-outline-info btn-sm visualizar_cargos" data-toggle="modal" data-target="#modal-default" value="<?php echo $datamodal_cargos ?>"><span class="fas fa-search-plus"></span></button></td>
                                        <td><a href="<?php echo base_url(); ?>Recursos_humanos/Controller_cargos/enlace_actualizar/<?php echo $grilla_cargos->id_cargo; ?>" class="btn btn-outline-warning btn-sm"><span class="far fa-edit"></a></td>
                                        <td><a href="<?php echo base_url(); ?>Recursos_humanos/Controller_cargos/eliminar/<?php echo $grilla_cargos->id_cargo; ?>" class="btn btn-outline-danger btn-sm"><span class="fas fa-trash-alt"></a></td>
                                    </tr>
                                <?php endforeach; ?>
