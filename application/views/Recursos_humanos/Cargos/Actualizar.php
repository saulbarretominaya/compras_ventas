                            ...
                            <div class="card-body">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="id_cargo" value="<?php echo $enlace_actualizar_cargos->id_cargo; ?>" name="id_cargo"> Codigo: </label>
                                        <input type="text" class="form-control" id="id_cargo" name="id_cargo" value="<?php echo $enlace_actualizar_cargos->id_cargo; ?>" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label for="descripcion">DESCRIPCIÓN</label>
                                        <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo $enlace_actualizar_cargos->descripcion; ?>">
                                    </div>
                                </div>
                            </div>
                        </form>
