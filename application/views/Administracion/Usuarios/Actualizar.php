<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?php echo base_url(); ?>Administracion/Controller_usuarios/actualizar" method="POST" class="form-horizontal">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <input type="hidden" name="id_usuario" value="<?php echo $enlace_actualizar_usuarios->id_usuario; ?>">
                            <input type="hidden" name="id_personal" id="id_personal" value="<?php echo $enlace_actualizar_usuarios->id_personal; ?> ">
                            <input type="text" class="form-control" disabled="disabled" id="ds_nombres" value="<?php echo $enlace_actualizar_usuarios->ds_nombres; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control" type="text" class="form-control" id="" name="usuario" value="<?php echo $enlace_actualizar_usuarios->usuario; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-8">
                                        <label for="">CONTRASEÑA</label>
                                        <input class="form-control" type="password" class="form-control" id="" name="contraseña" value="<?php echo $enlace_actualizar_usuarios->contraseña; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select class="form-select" id="id_rol" name="id_rol">
                                            <?php foreach ($multitablas_roles as $grilla_roles) : ?>
                                                <?php if ($grilla_roles->id_rol == $enlace_actualizar_usuarios->id_rol) : ?>
                                                    <option value="<?php echo $grilla_roles->id_rol ?>" selected>
                                ...
                                <div class="form-group">
                                    <div class="col-md-8">
                                        ...
                                        <select class="form-select" id="id_estado" name="id_estado">
                                            <?php foreach ($multitablas_estados as $grilla_estados) : ?>
                                                <?php if ($grilla_estados->id_estado == $enlace_actualizar_usuarios->id_estado) : ?>
                                                    <!-- Saul lo tienes que pasar con los mismos campos de cada tabla.-->
                                                    <option value="<?php echo $grilla_estados->id_estado ?>" selected>
                                                        <?php echo $grilla_estados->ds_estado; ?>
                                                    </option>
                                                <?php else : ?>
                                                    <option value="<?php echo $grilla_estados->id_estado ?>">
                                                        <?php echo $grilla_estados->ds_estado; ?>
                                                    </option>
                                                <?php endif; ?>
                                            <?php endforeach; ?>
