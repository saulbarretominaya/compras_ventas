<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form action="<?php echo base_url() ?>Inventario/Controller_categoria/actualizar" method="post">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="hidden" class="form-control" id="" name="id_categoria" value="<?php echo $enlace_actualizar_categoria->id_categoria; ?>" readonly="">
                                    <input type="text" class="form-control" id="" name="" value="<?php echo $enlace_actualizar_categoria->cod_categoria; ?>" readonly="">
                                </div>
                                <div class="form-group">
                                    <label for="nombre">NOMBRE</label>
                                    <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $enlace_actualizar_categoria->nombre; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="descripcion">DESCRIPCIÓN</label><br>
                                    <textarea name="descripcion" class="form-control" rows="3"><?php echo $enlace_actualizar_categoria->descripcion; ?></textarea>
                                </div>
                                <div class="form-group">
